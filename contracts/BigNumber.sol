...
library BigNumber {
    ...
    function _new(
        ...
        bool neg,
        bool copy
    ) public view returns (instance memory r) {
    ...
    function _new(
        ...
        bool neg,
        uint256 bitlen
    ) public pure returns (instance memory r) {
        uint256 val_msword;
        assembly {
    ...
    //calculate 4*a*b = (a+b)^2 - (a-b)^2, because division operation will cause error: "out of gas"
    function bn_mul4(instance memory a, instance memory b)
        public
        view
        returns (instance memory res)
    {
        ...
        // res = res / 4 ，没有这个，因为有两个for循环，run out of time报错
        return res;
    }
    ...
    function op_and_square(
        ...
        instance memory b,
        int256 op
    ) public view returns (instance memory res) {
    ...
    function prepare_modexp(
        ...
        instance memory modulus
    ) public view returns (instance memory result) {
    ...
    function modmul4(
        ...
        res = bn_mod(bn_mul4(a, b), modulus);
    }
        ...
        returns (bool)
    {
        ...
        int256 j;
        uint256 num_checks = prime_checks_for_size(a.bitlen);
